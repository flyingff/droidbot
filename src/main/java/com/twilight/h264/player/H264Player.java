...
public class H264Player implements Runnable {
	...
	public static void main(String[] args) throws FileNotFoundException {
		new H264Player(new FileInputStream("C:\\Users\\FlyingFF\\a.mp4"));
	}

	private Runnable pack;
	public H264Player(InputStream is) {
	...
	public boolean playFile(InputStream stream) {
	    H264Decoder codec;
	    MpegEncContext c= null;
	    InputStream fin = stream;
	    int frame, len;
